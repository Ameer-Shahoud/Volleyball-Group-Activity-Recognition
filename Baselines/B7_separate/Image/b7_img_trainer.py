...
from Baselines.B7_separate.Image.b7_img_model import B7ImgModel
...
class B7ImgTrainer(SingleLossTrainer):
    ...
    def _get_model(self) -> B7ImgModel:
        return B7ImgModel(self.pretrained_player_model_path)
